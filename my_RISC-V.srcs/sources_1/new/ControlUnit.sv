...
module ControlUnit (
    ...
    logic [5:0] signals;
    assign {regFileWe, aluSrcMuxSel, dataWe, wDataSrcMuxSel, branch, upper} = signals;

    always_comb begin : reg_we_sel
        signals = 6'b0;
        case (opcode)  //          F_A_D_W_B_U
            `R_Type:  signals = 6'b1_0_0_0_0_0;
            `S_Type:  signals = 6'b0_1_1_0_0_0;
            `L_Type:  signals = 6'b1_1_0_1_0_0;
            `I_Type:  signals = 6'b1_1_0_0_0_0;
            `B_Type:  signals = 6'b0_0_0_0_1_0;
            `LU_Type: signals = 6'b1_1_0_0_0_1;
            `AU_Type: signals = 6'b1_1_0_0_1_1;
        endcase
    end
    ...
    always_comb begin : alu_Control_sel
        ...
        case (opcode)
            ...
            `LU_Type: alu_Control = `SRL;
            `AU_Type: alu_Control = `SRL;
        endcase
    end
