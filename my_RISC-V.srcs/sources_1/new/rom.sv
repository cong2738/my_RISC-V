...
module rom (
    ...
    initial begin
        ...
        //B타입 시나리오: imm동작 검증1
        //          _imm7   _rs2  _rs1  _f3 _imm5 _opcode;      B_Type
        rom[0] = 32'b0000000_00001_00001_000_10000_1100011; //  BEQ rs1 == shamt; 1
        rom[1] = 32'b0000000_00001_00001_000_01000_1100011; //  BEQ rs1 == shamt; 무시되는 롬 데이터
        rom[2] = 32'b0000000_00010_00001_000_01000_1100011; //  BEQ rs1 == shamt; 1
        rom[3] = 32'b0000000_00010_00001_000_01000_1100011; //  BEQ rs1 == shamt; 0 롬데이터 4비트(단위길이1)이동
        rom[4] = 32'b0000000_00001_00001_000_01000_1100011; //  BEQ rs1 == shamt; 1 그냥 구분을 위해 넣은 라인
