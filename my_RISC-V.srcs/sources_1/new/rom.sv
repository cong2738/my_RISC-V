...
module rom (
    ...
    initial begin
        ...
        // // // R타입 롬시나리오
        // //          _funcn7 _rs2  _rs1  _f3 _rd   _opcode;       R_Type
        // rom[0]  = 32'b0100000_00001_00010_000_00001_0110011;  //   save 1
        // rom[1]  = 32'b0000000_00001_00010_000_00010_0110011;  //   ADD  x31, x2, x1
        // rom[2]  = 32'b0100000_00001_00001_000_00010_0110011;  //   SUB  x30, x2, x1
        // rom[3]  = 32'b0000000_00001_00001_001_00010_0110011;  //   SLL  x29, x2, x1
        // rom[4]  = 32'b0000000_00001_00001_101_00010_0110011;  //   SRL  x28, x2, x1
        // rom[5]  = 32'b0100000_00001_00001_101_00010_0110011;  //   SRA  x27, x2, x1
        // rom[6]  = 32'b0000000_00001_00010_010_00010_0110011;  //   SLT  x26, x2, x1
        // rom[7]  = 32'b0000000_00001_00010_011_00010_0110011;  //   SLTU x25, x2, x1
        // rom[8]  = 32'b0000000_00001_00000_100_00010_0110011;  //   XOR  x24, x2, x1
        // rom[9]  = 32'b0000000_00001_00010_110_00010_0110011;  //   OR   x23, x2, x1
        // rom[10] = 32'b0000000_00001_00010_111_00010_0110011;  //   AND  x22, x2, x1

        // // // J타입 롬시나리오
        // //          _imm      842           _rd   _opcode;       J_Type
        // rom[0] = 32'b0_0000000100_0_00000000_00011_1101111;  //   
        // // //       _funcn7 _rs2  _rs1  _f3 _rd   _opcode;       R_Type
        // rom[1] = 32'b0000000_00001_00010_000_00010_0110011;  //     처음엔 무시 이후에 동작
        // //          _imm         _rs1  _000 _rd   _opcode;       JL_Type
        // rom[2] = 32'b000000000100_00000_000_00100_1100111; //       rom2로 이동
        // // //       _funcn7 _rs2  _rs1  _f3 _rd   _opcode;       R_Type
