...
module rom (
    ...
    initial begin
        ...
        //          _imm7   _rs2  _rs1  _f3 _imm5 _opcode;      R_Type
        ...
        rom[2] = 32'b0000000_00010_00001_001_00010_1100011; //  BNE rs1 != shamt; 0
        rom[3] = 32'b0000000_00001_00001_001_00010_1100011; //  BNE rs1 != shamt; 1

        rom[4] = 32'b0000000_00001_00001_100_00010_1100011; //  BLT rs1 < shamt; 0
        rom[5] = 32'b0000000_00010_00001_100_00010_1100011; //  BLT rs1 < shamt; 0
        rom[6] = 32'b0000000_00001_00010_100_00010_1100011; //  BLT rs1 < shamt; 1

        rom[7] = 32'b0000000_00001_00001_101_00010_1100011; //  BGE rs1 >= shamt; 1
        rom[8] = 32'b0000000_00010_00001_101_00010_1100011; //  BGE rs1 >= shamt; 1
        rom[9] = 32'b0000000_00001_00010_101_00010_1100011; //  BGE rs1 >= shamt; 0
